...
import org.lisasp.results.base.api.type.*;
import org.lisasp.results.base.api.value.*;
...
public class JAuswertungImporter {
    ...
    private Entry[] importEntries(InputValueType inputValueType, org.lisasp.results.imports.jauswertung.model.Entry[] importedEntries) {
    ...
    private Swimmer[] toSwimmers(org.lisasp.results.imports.jauswertung.model.Swimmer[] swimmer) {
        if (swimmer == null) {
    ...
    private byte toPlace(InputValueType inputValueType, org.lisasp.results.imports.jauswertung.model.Entry importedEntry) {
    ...
    private int toTime(InputValueType inputValueType, org.lisasp.results.imports.jauswertung.model.Entry importedEntry) {
    ...
    private org.lisasp.results.imports.jauswertung.model.Competition deserialize(String json) throws FileFormatException {
        try {
