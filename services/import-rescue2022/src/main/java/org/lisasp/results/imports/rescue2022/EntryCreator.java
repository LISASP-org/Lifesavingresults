...
import org.lisasp.results.imports.rescue2022.model.result.MemField;
import org.lisasp.results.imports.rescue2022.model.result.Player;
...
import static org.lisasp.results.imports.rescue2022.NameHelper.fixName;
...
class EntryCreator {
    ...
    public org.lisasp.results.api.imports.Entry toEntry(org.lisasp.results.imports.rescue2022.model.result.Entry entry) {
        try {
            return org.lisasp.results.api.imports.Entry.builder()
    ...
    private SplitTime[] extractSplitTimes(org.lisasp.results.imports.rescue2022.model.result.Entry entry) {
    ...
    private String extractNumber(org.lisasp.results.imports.rescue2022.model.result.Entry entry) {
        return entry.getPlaTeamCod();
    }

    private Start extractStart(org.lisasp.results.imports.rescue2022.model.result.Entry entry) {
    ...
    private byte extractPlaceInHeat(org.lisasp.results.imports.rescue2022.model.result.Entry entry) {
