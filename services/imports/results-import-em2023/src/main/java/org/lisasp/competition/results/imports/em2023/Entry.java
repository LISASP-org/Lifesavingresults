...
public record Entry(String agegroup, String gender, String name, String club, int timeInMillis, String discipline, int rank, String penalty, String round, String date, String event, String yearOfBirth) {
