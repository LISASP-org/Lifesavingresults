...
class TimesServiceTests {
    ...
    public static final LocalDate DATE = LocalDate.of(2023, Month.JULY, 17);
    private static final CompetitionDto competition = new CompetitionDto("1", 1, "Name", "Acr", DATE, DATE);
    private static final EventDto event = new EventDto("2", 1, "AK 13/14", EventType.Individual, Gender.Male,
            "100m " + "Hindernisschwimmen", new Round((byte) 1, RoundType.Final), InputValueType.Time,
            CourseType.Long, DATE);
    private static final EventDto eventInvalid = new EventDto("2", 1, "AK 13/14", EventType.Individual, Gender.Male,
            "Invalid", new Round((byte) 1, RoundType.Final), InputValueType.Time, CourseType.Long, DATE);
    private static final EntryDto entry = new EntryDto("3", 1, "12", "Schwimmer", "Klub", "GER", 12345, 0,
            new Penalty[0], new Swimmer[0], new Start("1", (byte) 1));
    ...
    void receiveValidTime() {
        ...
        TimeDto[] times = service.findTimes(new TimesQuery(EventType.Individual, "AK 13/14", Gender.Male, "100m " +
                "Hindernisschwimmen"));

        assertEquals(1, times.length);
        assertEquals(new TimeDto("3", "Name", "Acr", EventType.Individual, "Schwimmer", "Klub", "GER", "AK 13/14",
                Gender.Male, "100m Hindernisschwimmen", 12345, CourseType.Long, DATE), times[0]);
    }
    ...
    void rescue2022MasterExample() {
        TimeDto expected = new TimeDto("a2e0253f-35b1-4497-aaee-06a479a8ae2b", "Rescue 2022", "Rescue2022",
                EventType.Team, "Gouda Reddingsbrigade", "Gouda Reddingsbrigade", "NED", "AK 140", Gender.Male,
                "4" + "*50m Hindernisstaffel", 153610, CourseType.Long, DATE);
        EntryChangedEvent event = new EntryChangedEvent(ChangeType.Created,
                new CompetitionDto("88be3d31-d2b4-48de" + "-8baa-f1cfaf8925bf", 1, "Rescue 2022", "Rescue2022",
                        LocalDate.of(2022, Month.SEPTEMBER, 30), LocalDate.of(2022, Month.SEPTEMBER, 30)),
                new EventDto("ba14373e-854a-44fc-b33c-1495aeac1057", 1, "M140-169", EventType.Team, Gender.Male,
                        ...
                        CourseType.Long, DATE), new EntryDto("a2e0253f-35b1-4497-aaee-06a479a8ae2b", 1, "5512",
                "Gouda Reddingsbrigade", "Gouda Reddingsbrigade", "NED", 153610, 0, new Penalty[0], new Swimmer[0],
                new Start("3", (byte) 7)));
        service.receive(event);

        TimeDto[] times = service.findTimes(new TimesQuery(EventType.Team, "AK 140", Gender.Male, "4*50m " +
                "Hindernisstaffel"));
