...
public class ImportController {
    ...
    @PutMapping("/competition/{id}/import/{uploadId}/jauswertung/{index}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void importCompetitionFromJAuswertung(@PathVariable String id, @PathVariable String uploadId, @PathVariable int index, @RequestBody String competition) throws NotFoundException, FileFormatException {
        service.importCompetitionFromJAuswertung(uploadId, competition);
    }
}
